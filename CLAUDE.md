...
load-bearing, a clap help string is one line, and the paragraph goes on the
reference page.

say what holds now, not what the old code did or which bug this closes
(`33b39f1`). that, and why the alternative was rejected, goes where the
changelog section already sends it: the pr description.
