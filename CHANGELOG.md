...
- the cli gets an agent guide: `.claude/skills/alembic/SKILL.md` states the identity and safety contract the command surface does not, `docs/agents.md` explains it, and `scripts/agent_fixtures.sh` exercises it against the fixtures in `fixtures/agent/` (#425)
